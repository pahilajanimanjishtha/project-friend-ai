...
import { 
  ...
  ShieldCheck, BookOpen, Cloud, Pill, Video, Volume2, VolumeX, Headphones, Sliders, TrendingUp, StickyNote, Wind, Brain, Cpu
} from 'lucide-react';
...
export default function Navigation({ 
  ...
  const abilities = [
    { id: 'chat', label: '🎥 Nova Tavus & Live Call', icon: Video, description: 'Real-time studio HD video companion call' },
